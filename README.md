Align your car with two strings and a ruler. 
...
2) The two orange STRING bars represent the measurement strings running alongside the car. The strings must be parallel to each other, but do not need to be parallel to the vehicle.
3) All wheel-to-string measurements are made perpendicular to the string. Measure from the front and rear edge of each wheel rim to the adjacent string.
